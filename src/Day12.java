...
public class Day12 extends Day{
	...
	private class Ship{			//keeps track of position of ship and moves it
		...
		private void doInstruction(Instruction instruction, Boolean s1) {	//s1 stand for Solution 1 - reusing code for solution 2
		...
		private void moveToWaypointMultipleTimes(int value) {
...
//start of Day 12 class
	...
	public int getSolution(Boolean s1) {
		Ship ship = new Ship();		//tracks state of ship and moves it
			
		for(Instruction i: instructions) ship.doInstruction(i, s1);		//do all instructions
